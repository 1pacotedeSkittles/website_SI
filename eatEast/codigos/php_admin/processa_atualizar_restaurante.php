...
try {
    ...
    // Atualizar a tabela Restaurante (dados simples)
    ...
    // Atualizar a tabela de Ligação (M:M)

    // ELIMINAR todas as ligações existentes para este restaurante
    ...
    // INSERIR as novas ligações selecionadas
